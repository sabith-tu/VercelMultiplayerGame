...
export function Row(...elements: HTMLElement[]): HTMLElement {
...
export function Column(...elements: HTMLElement[]): HTMLElement {
    let divElement = document.createElement("div");
...
export function Create(): HTMLElement {
    ...
    if (arguments.length === 0) return divElement;
...
export function Rectangle(width = 100, height = 100, color = "white"): HTMLElement {
